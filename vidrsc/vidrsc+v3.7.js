...
// @version      3.8
// @description  Full control UI (jump, autoplay, autonext, subtitle, server switch) for vidsrc.xyz, vidsrc.to, vsembed.ru, vidfast.pro, and godriveplayer embeds.
// @author       Doby_Don
// @match        *://vidsrc.to/*
// @match        *://vsembed.ru/embed/tv?*
// @match        *://vsembed.ru/embed/tv/*
// @match        *://vidfast.pro/*
...
// @downloadURL  https://github.com/Horyzontalhoror/user_script/raw/refs/heads/master/vidrsc/vidrsc+v3.7.js
// @updateURL  https://github.com/Horyzontalhoror/user_script/raw/refs/heads/master/vidrsc/vidrsc+v3.7.js
// ==/UserScript==
...
(function () {
  ...
  const SERVERS = {
    ...
    "vsembed.ru": "https://vsembed.ru/embed/tv",
  ...
  function detectBase() {
    ...
    if (host.includes("vsembed.ru")) return SERVERS["vsembed.ru"];
